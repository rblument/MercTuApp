 ...
 * CLASSPATH (default: Merc.properties in the /resources/ directory).
 * @author Rickb
 */
public class ResourceMgr {
     ...
     */
    private static final String PROPERTY_FILE_PATH = "/Merc.properties";
    ...
    /**
     * Local cache of properties loaded from the Merc.properties file.
     */
    private final Properties properties;
    
    /**
     * The current locale, as specified in the Merc.properties file
     */
     ...
     * 
     * @param path location of property file, e.g. "./Merc.properties"
     */
