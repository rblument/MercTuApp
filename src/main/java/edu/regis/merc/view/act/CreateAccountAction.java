 ...
 * @author rickb
 */
public class CreateAccountAction extends MercGuiAction {
    /**
     * Exceptions occurring in this class are also logged to this logger.
     */
    private static final Logger LOGGER = Logger.getLogger(CreateAccountAction.class.getName());

    /**
     * The single instance of this create account action.
     */
    private static final CreateAccountAction SINGLETON;
     ...
     */
    static {
        SINGLETON = new CreateAccountAction();
    }
     ...
     * @return
     */
    public static CreateAccountAction instance() {
        return SINGLETON;
    }
